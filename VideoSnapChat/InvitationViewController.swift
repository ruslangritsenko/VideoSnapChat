...
class InvitationViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let identifier = "InvitationVideoTableViewCell"
        let cell = tableView.dequeueReusableCell(withIdentifier: identifier, for: indexPath) as! InvitationVideoTableViewCell
    ...
    func fetchingMyVideoFiles() {
        ...
        videoRef.observeSingleEvent(of: .value, with: { snapshot in
            ...
            for  child in snapshot.children {
                ...
                let receive_email = value?[RECEIVER_EMAIL] as? String
                
                if receive_email == user_email{
