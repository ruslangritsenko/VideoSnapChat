//
//  YouAreFollwoingViewController.swift
//  VideoSnapChat
//
...
class YouAreFollwoingViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let identifier = "YouAreFollowingTableViewCell"
        let cell = tableView.dequeueReusableCell(withIdentifier: identifier, for: indexPath) as! YouAreFollowingTableViewCell
    ...
    func loadFollowYous(){
        ...
        let followYouRef = rootRef.child(USERS).child(uid).child(FOLLOWS)
    ...
    func loadUserInfo(cell : YouAreFollowingTableViewCell, index: Int){
